...
import '../../const/coreConstant.dart';

enum CoreButtonType { elevated, outlined, text }
...
class CoreButton extends StatelessWidget {
  ...
  CoreButton.text(
      ...
      this.msBackgroundColor,
      this.backgroundColor,
      this.buttonType = CoreButtonType.text,
      this.style,
      this.msSide,
      this.disabled = false,
      this.side,
  ...
  CoreButton.outlined(
      ...
      this.msBackgroundColor,
      this.backgroundColor,
      this.buttonType = CoreButtonType.outlined,
      this.style,
      this.msSide,
      this.block = false,
      this.side,
  ...
  Widget build(BuildContext context) {
    ...
    if (buttonType == CoreButtonType.outlined) {
                ...
                shape: MaterialStateProperty.all(shape ??
                    RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(
                          borderRadiusAll ?? CoreConstant.constant.buttonRadius),
                    ))),
      );
    } else if (buttonType == CoreButtonType.elevated) {
                  ...
                  shape: MaterialStateProperty.all(shape ??
                      RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(borderRadiusAll ??
                            CoreConstant.constant.buttonRadius),
                      ))),
          onPressed: onPressed,
          child: child);
    } else {
